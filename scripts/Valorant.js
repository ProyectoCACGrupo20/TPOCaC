...
var armasPorCategoria = {
    "Pistolas": [
        { nombre: "Classic", imagen: "/src/Valorant_src/Img/Armas/Pistolas/Classic.webp", descripcion: "El disparo principal realiza disparos precisos al estar quieto y tiene un modo de disparo alternativo para encuentros cercanos." },
        { nombre: "Shorty", imagen: "/src/Valorant_src/Img/Armas/Pistolas/Shorty.webp", descripcion: "Una escopeta de cañón corto y ágil; letal a corta distancia, pero solo puede disparar dos veces antes de tener que recargarla. Se combina bien con las armas de largo alcance." },
        { nombre: "Frenzy", imagen: "/src/Valorant_src/Img/Armas/Pistolas/Frenzy.webp", descripcion: "Ametralladora ligera que destaca al disparar en movimiento. Su alta velocidad de disparo puede llegar a ser difícil de controlar, así que prueba ráfagas cortas a media distancia." },
        { nombre: "Ghost", imagen: "/src/Valorant_src/Img/Armas/Pistolas/Ghost.webp", descripcion: "La Ghost es precisa y tiene un gran cargador en caso de que falles. Los objetivos distantes requieren una tasa de fuego controlada. Presiona rápidamente el gatillo cuando veas lo blanco de sus ojos." },
        { nombre: "Sheriff", imagen: "/src/Valorant_src/Img/Armas/Pistolas/Sheriff.webp", descripcion: "Sus balas de alto impacto tienen mucho retroceso y se necesitan muchas agallas para dominarlas. Si dominas la Sheriff correctamente, tus enemigos sabrán que no tenían oportunidad." },
    ],
    "Subfusiles": [
        { nombre: "Stinger", imagen: "/src/Valorant_src/Img/Armas/Subfusiles/Stinger.webp", descripcion: "Este subfusil tiene mayor potencia a corta y larga distancia que los demás, pero a costa de velocidad de disparo y movilidad. Su cargador de 20 rondas se desperdicia en ráfagas llenas de retroceso, pero asesta golpes letales a media distancia con la mira y fuego controlado." },
        { nombre: "Spectre", imagen: "/src/Valorant_src/Img/Armas/Subfusiles/Spectre.webp", descripcion: "Un arma todoterreno con gran equilibrio de daño, velocidad de disparo y precisión, tanto a corta como larga distancia. Acecha los rincones de cada mapa y solo requiere que apuntes firme para derribar a los enemigos a larga distancia." }
    ],
    "Escopetas": [
        { nombre: "Bucky", imagen: "/src/Valorant_src/Img/Armas/Escopetas/Bucky.webp", descripcion: "Pesada, pero estable. El disparo principal de la Bucky es para mantener las esquinas cerradas o disparar a corta distancia. El disparo secundario sirve para los objetivos a medio alcance." },
        { nombre: "Judge", imagen: "/src/Valorant_src/Img/Armas/Escopetas/Judge.webp", descripcion: "La Judge es estable con disparos premeditados, pero volátil si la disparas rápidamente. El disparo principal ataca a los objetivos a corta distancia y tendrás que ser firme para alcanzar todo lo que esté más allá de la longitud de tu brazo." },
    ],
    "Rifles": [
        { nombre: "Bulldog", imagen: "/src/Valorant_src/Img/Armas/Rifles/Bulldog.webp", descripcion: "Es una bestia a la hora de intercambiar fuego. El disparo alternativo te permite utilizar una mira y lanzar ráfagas cortas y precisas a todo aquel que intente cazarte a media o larga distancia." },
        { nombre: "Guardian", imagen: "/src/Valorant_src/Img/Armas/Rifles/Guardian.webp", descripcion: "Es el rifle para los tiradores entrenados. Más pesado y menos móvil en comparación con otros rifles, pero más preciso y potente. Comienza la cacería de tus enemigos a media y larga distancia." },
        { nombre: "Phantom", imagen: "/src/Valorant_src/Img/Armas/Rifles/Phantom.webp", descripcion: "Úsala en automático contra cualquiera que te ponga a prueba de cerca. Por otro lado, sus ráfagas cortas y controladas permiten derribar enemigos a cualquier distancia. Funciona mejor cuando no estás en movimiento." },
        { nombre: "Vandal", imagen: "/src/Valorant_src/Img/Armas/Rifles/Vandal.webp", descripcion: "El Vandal tiene un alto daño a distancia y recompensa a quienes se enfocan en un solo disparo a la cabeza. Sin embargo, su disparo extendido da como resultado menor estabilidad." },
    ],
    "Francotiradores": [
        { nombre: "Marshal", imagen: "/src/Valorant_src/Img/Armas/Francotiradores/Marshal.webp", descripcion: "Un ágil rifle de palanca con un solo zoom que puede mantener a raya a los enemigos. Una velocidad de disparo lenta significa que tienes que dar en el blanco o quedarás expuesto a los ataques." },
        { nombre: "Operator", imagen: "/src/Valorant_src/Img/Armas/Francotiradores/Operator.webp", descripcion: "Un rifle de francotirador con doble zoom de alta potencia. Extremadamente inmóvil, pero sus poderosas balas podrían devastar a un equipo con un solo disparo." },
    ],
    "Ametralladoras Pesadas": [
        { nombre: "Ares", imagen: "/src/Valorant_src/Img/Armas/Ametralladoras Pesadas/Ares.webp", descripcion: "El enorme cargador del Ares significa que sobresale en el fuego continuo e inflige daño masivo a grupos de enemigos." },
        { nombre: "Odin", imagen: "/src/Valorant_src/Img/Armas/Ametralladoras Pesadas/Odin.webp", descripcion: "Disparos continuos de alto daño con una gran estabilidad. Pulveriza a los enemigos a corta distancia y usa el disparo alternativo para convertirte en una torreta viviente." },
    ],
    "Cuerpo a Cuerpo": [
        { nombre: "Cuchillo Táctico", imagen: "/src/Valorant_src/Img/Armas/Cuerpo a Cuerpo/Cuchillo.webp", descripcion: "Cuando tengas dudas o se te acaben las balas, atácalos con esto. Te permite correr rápido, destruir objetos o lanzárselo a los enemigos por la espalda con el disparo alternativo." },
    ]
};
